...
void myPiece::load(int pieceNumber, int size) {
	...
	case 1:
		...
		for (int i = 0; i < piece.getVertexCount(); i++) {
			piece[i].color = sf::Color(255, 215, 0); //yellow
		}
		break;
	case 2:
		piece.resize(11);
		...
		for (int i = 0; i < piece.getVertexCount(); i++) {
			piece[i].color = sf::Color(255, 69, 0); //yellow
		}
		break;
	case 3:
		piece.resize(17);
		...
		for (int i = 0; i < piece.getVertexCount(); i++) {
			piece[i].color = sf::Color(0, 0, 139); //yellow
		}
		break;
	case 4:
		piece.resize(23);
		...
		for (int i = 0; i < piece.getVertexCount(); i++) {
			piece[i].color = sf::Color(139, 0, 0); //yellow
		}
		break;
	case 5:
		piece.resize(23);
		...
		makeBox(size, 18, piece[17].position);
		for (int i = 0; i < piece.getVertexCount(); i++) {
			piece[i].color = sf::Color(139, 69, 19); //yellow
		}
		break;
	case 6:
		piece.resize(24);
		...
		for (int i = 0; i < piece.getVertexCount(); i++) {
			piece[i].color = sf::Color(112, 128, 144); //yellow
		}
		break;
	case 7:
		piece.resize(23);
		...
		makeBox(size, 18, piece[17].position);
		for (int i = 0; i < piece.getVertexCount(); i++) {
			piece[i].color = sf::Color(0, 255, 0); //yellow
		}
		break;
	case 8:
		piece.resize(23);
		...
		makeBox(size, 18, piece[17].position);
		for (int i = 0; i < piece.getVertexCount(); i++) {
			piece[i].color = sf::Color(139, 0, 139); //yellow
		}
		break;
	case 9:
		piece.resize(17);
		...
		makeBox(size, 12, piece[11].position);
		for (int i = 0; i < piece.getVertexCount(); i++) {
			piece[i].color = sf::Color(0, 191, 255); //yellow
		}
		break;
	}
