...
Piece9::Piece9()
{
	pieces[0] = (new Board(Vector2f(900, 0), Vector2f(100, 100), Color(165, 42, 42), false, false));
	pieces[1] = (new Board(Vector2f(1000, 0), Vector2f(100, 100), Color(165, 42, 42), false, false));
